...
import { debugModuleFor, type ActiveModule, type ConnectionMode, type LogEntry, type LogValues, type MotorDebugHandshakeStatus, type MotorErrorDisplay, type PendingCommandResponse, type PendingDebugSet } from "@app/appModel";
