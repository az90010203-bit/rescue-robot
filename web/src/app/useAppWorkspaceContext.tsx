...
import { MachineClawConfigPatch, normalizeMachineClawConfigPatch } from "@domains/machine-claw/machineClaw";
...
export function useAppWorkspaceContext() {
  ...
  const {
    ...
    flushTelemetryQueue, i18n, inputMapping, lastMotorError, linkageWheelDirectionByGroup, logs, machineClawTestConfig, motorDraft, motorFeedback,
    ...
    setLastDatabaseSavedAt, setLastMotorError, setLinkageWheelDirectionByGroup, setLogs, setMachineClawTestConfig, setMappingDraft, setMotorDraft, setMotorFeedback, setMotorLinkageGroups,
  ...
  async function sendPiServoBridgeCommand(command: PcCommand, waitMs = 80, options?: ServoFrameSendOptions) {
    return sendServoCommand(command, waitMs, true, options);
  }
  function updateMachineClawTestConfig(patch: MachineClawConfigPatch) {
    setMachineClawTestConfig((current) => normalizeMachineClawConfigPatch(current, patch));
  }
