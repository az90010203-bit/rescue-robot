...
import type { MotorProfile } from "@adapters/hardware/protocol";
import type { MotorLinkageGroup } from "@adapters/persistence/storage";
import { calculateMotorLinkageTargets } from "@adapters/persistence/storage";
